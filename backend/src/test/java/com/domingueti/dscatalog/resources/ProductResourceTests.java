...
import com.domingueti.dscatalog.services.ProductService;
...
public class ProductResourceTests {
	...
	void setup() {
		...
		doThrow(DatabaseException.class).when(service).delete(integrityId);

		when(service.insert((ProductDTO) any())).thenReturn(productDTO);
	}
	...
	@Test
	public void deleteShouldThrowDatabaseFoundExceptionWhenIdIsAssociatedWithObject() throws Exception {

		ResultActions result = mockMvc
				.perform(delete("/products/{id}", integrityId).accept(MediaType.APPLICATION_JSON));
	...
	@Test
	public void insertShouldReturn210AndProductDTOWhenInsertedDTOIsValid() throws Exception {
